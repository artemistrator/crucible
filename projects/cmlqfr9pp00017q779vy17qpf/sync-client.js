...
const DEFAULT_API_URL = 'http://localhost:3000/api/sync';
...
function startWatcher(projectId, apiUrl, commandApiUrl, autoApprove = false, rootDir = process.cwd()) {
...
`);
  ...
  const watcher = startWatcher(projectId, apiUrl, commandApiUrl, autoApprove);
