...
${x}`,authorRole:"TEAMLEAD"}}),{taskId:b,oldDescription:e.description,newDescription:d}):null});return{needsUpdates:!0,reasoning:x,updatedTasks:(await Promise.all(y)).filter(a=>null!==a)}}},10846:a=>{a.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},19121:a=>{a.exports=require("next/dist/server/app-render/action-async-storage.external.js")},28354:a=>{a.exports=require("util")},29021:a=>{a.exports=require("fs")},29294:a=>{a.exports=require("next/dist/server/app-render/work-async-storage.external.js")},33873:a=>{a.exports=require("path")},44870:a=>{a.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},50048:(a,b,c)=>{c.r(b),c.d(b,{handler:()=>I,patchFetch:()=>H,routeModule:()=>D,serverHooks:()=>G,workAsyncStorage:()=>E,workUnitAsyncStorage:()=>F});var d={};c.r(d),c.d(d,{GET:()=>B,OPTIONS:()=>A,POST:()=>C,dynamic:()=>z});var e=c(95736),f=c(9117),g=c(4044),h=c(39326),i=c(32324),j=c(261),k=c(54290),l=c(85328),m=c(38928),n=c(46595),o=c(3421),p=c(17679),q=c(41681),r=c(63446),s=c(86439),t=c(51356),u=c(10641),v=c(70373),w=c(99104),x=c(5495),y=c(38842);let z="force-dynamic";async function A(a){return new Response(null,{status:200,headers:{"Access-Control-Allow-Origin":"*","Access-Control-Allow-Methods":"GET, POST, OPTIONS","Access-Control-Allow-Headers":"Content-Type, Authorization"}})}async function B(a){let{searchParams:b}=a.nextUrl,c=b.get("action");try{if("list_tasks"===c){let a=b.get("projectId");if(!a)return u.NextResponse.json({error:"projectId is required"},{status:400});let c=await v.z.task.findMany({where:{plan:{projectId:a}},orderBy:{createdAt:"asc"}});return u.NextResponse.json({tasks:c})}if("read_task"===c){let a=b.get("taskId");if(!a)return u.NextResponse.json({error:"taskId is required"},{status:400});let c=await v.z.task.findUnique({where:{id:a}});if(!c)return u.NextResponse.json({error:"Task not found"},{status:404});return u.NextResponse.json({task:c})}if("get_next_task"===c){let a=b.get("projectId");if(!a)return u.NextResponse.json({error:"projectId is required"},{status:400});let c=(await v.z.task.findMany({where:{plan:{projectId:a},status:"TODO"},include:{dependencies:{include:{dependsOn:{select:{id:!0,status:!0}}}}},orderBy:{createdAt:"asc"}})).filter(a=>{let b=a.dependencies??[];return 0===b.length||b.every(a=>"DONE"===a.dependsOn.status)})[0]??null;return u.NextResponse.json({task:c})}return u.NextResponse.json({error:"Invalid action"},{status:400})}catch(a){return console.error("[API/IDE] Error in GET",a),u.NextResponse.json({error:"Internal Server Error"},{status:500})}}async function C(a){try{let b=await a.json(),{action:c,taskId:d,status:e}=b;if("update_task_status"===c){if(!d||!e)return u.NextResponse.json({error:"taskId and status are required"},{status:400});if("DONE"===e){let a=await v.z.task.findUnique({where:{id:d},include:{comments:{orderBy:{createdAt:"desc"},take:1},plan:{include:{project:{select:{id:!0}}}}}});if(!a)return u.NextResponse.json({error:"Task not found"},{status:404});let b=a.comments[0],c=b?.content||"Отсутствует отчет о выполнении",e=await (0,y.L)(d,c);if("APPROVED"===e.status){let a=await v.z.task.findUnique({where:{id:d},include:{plan:{include:{project:{select:{id:!0,requireApproval:!0}}}}}});if(!a)return u.NextResponse.json({error:"Task not found"},{status:404});if(a.plan?.project?.requireApproval&&"WAITING_APPROVAL"===a.status)return u.NextResponse.json({success:!0,task:a,qaApproved:!0,qaReasoning:e.reasoning,message:"Задача одобрена QA агентом. Ожидает подтверждения человека."});if(a.plan?.project?.id&&"DONE"===a.status)try{await (0,x.C)(a.plan.project.id,d),await (0,x.N)(a.plan.project.id,d)}catch(a){}return u.NextResponse.json({success:!0,task:a,qaApproved:!0,qaReasoning:e.reasoning})}{let a=await v.z.task.findUnique({where:{id:d}});return await v.z.comment.create({data:{taskId:d,content:`❌ QA ОТКЛОНЕНИЕ

${e.reasoning}

Уверенность: ${(100*e.confidence).toFixed(0)}%

Пожалуйста, предоставьте более детальный отчет с доказательствами (логи тестов, результаты сборки, скриншоты).`,authorRole:"TEAMLEAD"}}),u.NextResponse.json({success:!1,task:a,qaApproved:!1,qaReasoning:e.reasoning,debugSummary:e.debugSummary,message:"Задача отклонена QA агентом. Требуется доработка."},{status:400})}}let a=await v.z.task.update({where:{id:d},data:{status:e}});return u.NextResponse.json({success:!0,task:a})}if("generate_prompt"===c){let a=b.taskId;if(!a||"string"!=typeof a)return u.NextResponse.json({error:"taskId is required"},{status:400});let c=await (0,w.J)(a);return u.NextResponse.json({success:!0,prompt:c})}if("add_comment"===c){let{taskId:a,content:c,role:d="DEVOPS"}=b;if(!a||"string"!=typeof a||!c||"string"!=typeof c)return u.NextResponse.json({error:"taskId and content are required"},{status:400});let e=await v.z.comment.create({data:{taskId:a,content:c,authorRole:d}});return u.NextResponse.json({comment:e})}return u.NextResponse.json({error:"Invalid action"},{status:400})}catch(a){return console.error("[API/IDE] Error in POST",a),u.NextResponse.json({error:"Internal Server Error"},{status:500})}}let D=new e.AppRouteRouteModule({definition:{kind:f.RouteKind.APP_ROUTE,page:"/api/ide/route",pathname:"/api/ide",filename:"route",bundlePath:"app/api/ide/route"},distDir:".next",relativeProjectDir:"",resolvedPagePath:"/Users/artem/Desktop/cursor-diriger/ai-orchestrator/app/api/ide/route.ts",nextConfigOutput:"standalone",userland:d}),{workAsyncStorage:E,workUnitAsyncStorage:F,serverHooks:G}=D;function H(){return(0,g.patchFetch)({workAsyncStorage:E,workUnitAsyncStorage:F})}async function I(a,b,c){var d;let e="/api/ide/route";"/index"===e&&(e="/");let g=await D.prepare(a,b,{srcPage:e,multiZoneDraftMode:!1});if(!g)return b.statusCode=400,b.end("Bad Request"),null==c.waitUntil||c.waitUntil.call(c,Promise.resolve()),null;let{buildId:u,params:v,nextConfig:w,isDraftMode:x,prerenderManifest:y,routerServerContext:z,isOnDemandRevalidate:A,revalidateOnlyGenerated:B,resolvedPathname:C}=g,E=(0,j.normalizeAppPath)(e),F=!!(y.dynamicRoutes[E]||y.routes[C]);if(F&&!x){let a=!!y.routes[C],b=y.dynamicRoutes[E];if(b&&!1===b.fallback&&!a)throw new s.NoFallbackError}let G=null;!F||D.isDev||x||(G="/index"===(G=C)?"/":G);let H=!0===D.isDev||!F,I=F&&!H,J=a.method||"GET",K=(0,i.getTracer)(),L=K.getActiveScopeSpan(),M={params:v,prerenderManifest:y,renderOpts:{experimental:{cacheComponents:!!w.experimental.cacheComponents,authInterrupts:!!w.experimental.authInterrupts},supportsDynamicResponse:H,incrementalCache:(0,h.getRequestMeta)(a,"incrementalCache"),cacheLifeProfiles:null==(d=w.experimental)?void 0:d.cacheLife,isRevalidate:I,waitUntil:c.waitUntil,onClose:a=>{b.on("close",a)},onAfterTaskError:void 0,onInstrumentationRequestError:(b,c,d)=>D.onRequestError(a,b,d,z)},sharedContext:{buildId:u}},N=new k.NodeNextRequest(a),O=new k.NodeNextResponse(b),P=l.NextRequestAdapter.fromNodeNextRequest(N,(0,l.signalFromNodeResponse)(b));try{let d=async c=>D.handle(P,M).finally(()=>{if(!c)return;c.setAttributes({"http.status_code":b.statusCode,"next.rsc":!1});let d=K.getRootSpanAttributes();if(!d)return;if(d.get("next.span_type")!==m.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${d.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let e=d.get("next.route");if(e){let a=`${J} ${e}`;c.setAttributes({"next.route":e,"http.route":e,"next.span_name":a}),c.updateName(a)}else c.updateName(`${J} ${a.url}`)}),g=async g=>{var i,j;let k=async({previousCacheEntry:f})=>{try{if(!(0,h.getRequestMeta)(a,"minimalMode")&&A&&B&&!f)return b.statusCode=404,b.setHeader("x-nextjs-cache","REVALIDATED"),b.end("This page could not be found"),null;let e=await d(g);a.fetchMetrics=M.renderOpts.fetchMetrics;let i=M.renderOpts.pendingWaitUntil;i&&c.waitUntil&&(c.waitUntil(i),i=void 0);let j=M.renderOpts.collectedTags;if(!F)return await (0,o.I)(N,O,e,M.renderOpts.pendingWaitUntil),null;{let a=await e.blob(),b=(0,p.toNodeOutgoingHttpHeaders)(e.headers);j&&(b[r.NEXT_CACHE_TAGS_HEADER]=j),!b["content-type"]&&a.type&&(b["content-type"]=a.type);let c=void 0!==M.renderOpts.collectedRevalidate&&!(M.renderOpts.collectedRevalidate>=r.INFINITE_CACHE)&&M.renderOpts.collectedRevalidate,d=void 0===M.renderOpts.collectedExpire||M.renderOpts.collectedExpire>=r.INFINITE_CACHE?void 0:M.renderOpts.collectedExpire;return{value:{kind:t.CachedRouteKind.APP_ROUTE,status:e.status,body:Buffer.from(await a.arrayBuffer()),headers:b},cacheControl:{revalidate:c,expire:d}}}}catch(b){throw(null==f?void 0:f.isStale)&&await D.onRequestError(a,b,{routerKind:"App Router",routePath:e,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:A})},z),b}},l=await D.handleResponse({req:a,nextConfig:w,cacheKey:G,routeKind:f.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:y,isRoutePPREnabled:!1,isOnDemandRevalidate:A,revalidateOnlyGenerated:B,responseGenerator:k,waitUntil:c.waitUntil});if(!F)return null;if((null==l||null==(i=l.value)?void 0:i.kind)!==t.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==l||null==(j=l.value)?void 0:j.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});(0,h.getRequestMeta)(a,"minimalMode")||b.setHeader("x-nextjs-cache",A?"REVALIDATED":l.isMiss?"MISS":l.isStale?"STALE":"HIT"),x&&b.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let m=(0,p.fromNodeOutgoingHttpHeaders)(l.value.headers);return(0,h.getRequestMeta)(a,"minimalMode")&&F||m.delete(r.NEXT_CACHE_TAGS_HEADER),!l.cacheControl||b.getHeader("Cache-Control")||m.get("Cache-Control")||m.set("Cache-Control",(0,q.getCacheControlHeader)(l.cacheControl)),await (0,o.I)(N,O,new Response(l.value.body,{headers:m,status:l.value.status||200})),null};L?await g(L):await K.withPropagatedContext(a.headers,()=>K.trace(m.BaseServerSpan.handleRequest,{spanName:`${J} ${a.url}`,kind:i.SpanKind.SERVER,attributes:{"http.method":J,"http.target":a.url}},g))}catch(b){if(b instanceof s.NoFallbackError||await D.onRequestError(a,b,{routerKind:"App Router",routePath:E,routeType:"route",revalidateReason:(0,n.c)({isRevalidate:I,isOnDemandRevalidate:A})}),F)throw b;return await (0,o.I)(N,O,new Response(null,{status:500})),null}}},55511:a=>{a.exports=require("crypto")},63033:a=>{a.exports=require("next/dist/server/app-render/work-unit-async-storage.external.js")},68488:(a,b,c)=>{c.d(b,{L:()=>h,q:()=>i});var d=c(96940),e=c(70373),f=c(32838),g=c(71953);async function h(a,b){let c=await e.z.project.findUnique({where:{id:a}}),h=await e.z.plan.findUnique({where:{id:b}});if(!c||!h)throw Error("Project or plan not found");let i=`Ты — Software Architect. Мы начинаем проект "${c.ideaText}".
Выбран план: "${h.title}".
Стек: ${h.techStack}.
...
## Consequences
Плюсы: ...
Минусы: ...`,j=(0,f.Kd)(c.aiProvider??void 0),k=c.aiModel??"gpt-4o-mini",l=(0,f.E1)(j,k),m=c.aiModel??`${j}/${k}`,n=await (0,d.Df)({model:l,system:"Ты опытный Software Architect. Пиши чёткие и структурированные ADR. У тебя есть доступ в интернет через webSearch. Если нужна свежая документация — ГУГЛИ. Не гадай.",prompt:i,temperature:.3});return await (0,g.X)(n,{projectId:a,planId:b,actionType:"generate-adr",model:m}),n.text}async function i(a,b,c){return await e.z.syncCommand.create({data:{projectId:a,command:`Create file: docs/adr/${b}`,type:"WRITE_FILE",filePath:`docs/adr/${b}`,fileContent:c}})}},79646:a=>{a.exports=require("child_process")},86439:a=>{a.exports=require("next/dist/shared/lib/no-fallback-error.external")},96330:a=>{a.exports=require("@prisma/client")}};var b=require("../../../webpack-runtime.js");b.C(a);var c=b.X(0,[5873,1692,4120,6940,851,4491,9536,3231,4241],()=>b(b.s=50048));module.exports=c})();